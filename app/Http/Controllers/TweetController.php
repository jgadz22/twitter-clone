...
class TweetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $tweet->name = 'Joseph Gadiaza';
        $tweet->handle = '@josephgadiaza';
        $tweet->image ='https://yt3.ggpht.com/yti/AHXOFjWsyXTxpxfUhgbvnFouU8odIpdNy6BflZagIYFfLw=s88-c-k-c0x00ffffff-no-rj-mo';
